...
layui.config({
	...
	var form = layui.form(),
		...
		tab = layui.bodyTab({
			...
			url : "json/usernavs.json" //获取菜单json地址
		});
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							...
							'<div class="admin-header-lock-name" id="lockUserName">请叫我李哥</div>'+
							'<div class="input_btn">'+
